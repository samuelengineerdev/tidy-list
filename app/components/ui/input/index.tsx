...
const inputStyle = tva({
  base: 'border border-input flex-row overflow-hidden content-center data-[hover=true]:border-outline-400 data-[focus=true]:border-primary-700 data-[focus=true]:hover:border-primary-700 data-[disabled=true]:opacity-40 data-[disabled=true]:hover:border-background-300 items-center bg-background',
...
const inputIconStyle = tva({
  base: 'justify-center items-center text-typography-400 fill-none bg-background text-foreground',
  parentVariants: {
    size: {
      '2xs': 'h-3 w-3',
      'xs': 'h-3.5 w-3.5',
...
const inputFieldStyle = tva({
  ...
  base: ' bg-background ring-offset-background file:border-0 file:bg-transparent  file:text-foreground text-foreground placeholder:text-muted-foreground  flex-1 py-0 px-3 h-full ios:leading-[0px] web:cursor-text web:data-[disabled=true]:cursor-not-allowed',
